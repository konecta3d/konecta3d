...
export function LeadMagnetPreview({
  ...
  const previewPadding = "20mm";
  const previewBottom = "60px";
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            borderBottom: `2px solid ${colorBrand}`,
            paddingBottom: "20px",
            marginBottom: "30px",
          }}
        >
            ...
            {showLogo && logoUrl && (
              <img
                ...
                style={{
                  ...
                  width: `${logoSize}px`,
                  objectFit: "contain",
                  borderRadius: logoSize >= 40 ? "9999px" : "6px",
                }}
              />
            )}
            <div
        ...
        <div
          style={{
            fontSize: `${titleSizePreview * 1.2}rem`,
            fontWeight: 900,
            color: colorTitle,
            lineHeight: 1.1,
            marginBottom: "24px",
        ...
        <div style={{ marginBottom: "36px" }}>
          <h4
            style={{
              ...
              fontSize: "1.08rem",
              textTransform: "uppercase",
              borderLeft: `4px solid ${colorBrand}`,
              paddingLeft: "12px",
              marginBottom: "18px",
            }}
          >
        ...
        {/* SN Section - positioned above CTA buttons */}
        ...
        {/* CTA Box - Absolute positioned at bottom */}
        <div
          style={{
            position: "absolute",
