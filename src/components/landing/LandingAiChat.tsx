    ...
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] flex flex-col h-[calc(100vh-180px)] min-h-[500px] lg:sticky lg:top-6">
      ...
      {profileState === "incomplete" && (
        <div className="mx-3 mt-2 rounded-lg border border-amber-500/30 bg-amber-500/8 px-3 py-2 flex items-start gap-2">
          ...
          <p className="text-xs text-[var(--foreground)]/70 leading-relaxed">
            El asistente IA necesita tu contexto completo para funcionar bien y personalizar sus propuestas. Sin él, las respuestas serán genéricas.{" "}
      ...
      <div className="border-t border-[var(--border)] p-3 space-y-2">
        {/* Nivel 3 — montar una primera versión completa de una pasada.
            ...
            personalizar y el montaje falla). La zanahoria: completar el contexto. */}
        {!completed && (
          profileState === "ready" ? (
            <button
              type="button"
