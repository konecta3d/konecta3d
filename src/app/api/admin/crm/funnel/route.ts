...
import { DEFAULT_FUNNEL } from "@/lib/crm/funnel";

const KEY = "crm_funnel";
...
/** GET — embudo guardado o el de por defecto. Solo admin. */
export async function GET(req: Request) {
  ...
  try {
    ...
    return NextResponse.json({ funnel: DEFAULT_FUNNEL });
  } catch {
    return NextResponse.json({ funnel: DEFAULT_FUNNEL });
  }
}
