...
export default function BusinessLoginForm({ initialConfig }: { initialConfig: LoginPageConfig }) {
  const router = useRouter();
  // La config llega ya resuelta desde el servidor → sin salto de la pantalla base.
  const cfg = { ...DEFAULT_LOGIN_CONFIG, ...initialConfig };
