# Modelo de negocio Konecta3D — Índice

> Documentos maestros. Fuente de verdad para decisiones de producto, precio, venta y operaciones.
> Editable por Miguel y Miriam. No improvisar: si hay duda, consultar aquí primero.
...
| Archivo | Contenido |
|---|---|
| [01-pilares.md](01-pilares.md) | Los 8 pilares del negocio con estado y decisiones tomadas |
| [02-precio-y-oferta.md](02-precio-y-oferta.md) | Estructura de precios, oferta de entrada, política de descuentos |
| [03-pipeline-seguimiento.md](03-pipeline-seguimiento.md) | Etapas del cliente + tabla de 11 contactos con mensajes reales |
...
## Estado del negocio (actualizar con cada hito)
