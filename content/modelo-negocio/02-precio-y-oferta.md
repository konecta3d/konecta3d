# Precio y oferta — Konecta3D

> Qué se cobra, cuánto, cómo y en qué condiciones.
> Fuente de verdad para cualquier conversación de precio.
...
## Precio de los llaveros

- **Precio por unidad:** ~3 € + IVA
- **Lote mínimo:** 100 unidades
- **Envío:** gratuito
- **Precio no negociable.** Si hay que dar valor extra para cerrar: unidades adicionales (10-15), nunca descuento monetario.

### Packs orientativos

| Pack | Unidades | Precio |
|---|---|---|
| Inicio | 100 u | ~300 € + IVA |
| Medio | 250 u | ~750 € + IVA |
| Alto | 500 u | ~1.500 € + IVA |

*(Precios a confirmar con fabricante según pedido)*
...
- El cliente personaliza su plataforma durante ese mes
- Ese mismo mes se usa para fabricar y enviar los llaveros → el cliente ya tiene todo listo cuando termina la prueba
- Si al mes no han capturado ningún lead porque no usaron el sistema, no se extiende el período

---

## Cómo se cobra

1. Presupuesto enviado por escrito (email o PDF)
2. Transferencia bancaria antes de procesar el pedido de llaveros
3. La suscripción mensual se activa pasado el mes de prueba gratuita
...
**¿Qué pasa si no uso el sistema?**
Los resultados dependen del uso. El sistema no funciona solo si el llavero está en un cajón. El seguimiento del primer mes existe precisamente para que esto no pase.
...
*Precios establecidos junio 2026. Revisar tras 6 meses de operación real.*
